...
.DESCRIPTION
 ...
 5) Before anything else, writes a 30‑minute countdown to the log, one entry per minute.
...
$LogFile = Join-Path $PSScriptRoot 'AutoSignOut30.log'

# Initialize log file
"==== AutoSignOut 30 min started: $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') ====" |
...
for ($minutes = 30; $minutes -ge 1; $minutes--) {
